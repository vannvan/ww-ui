...
<div class="demo-block">
  ...
  <div class='m-10'>
    ...
    <w-button type="info" loading>信息按钮</w-button>
...
<div class="demo-block">
  <w-button icon="icon-chevron-left" type="primary">返回</w-button>
  <w-button icon="icon-close" type="danger">关闭</w-button>
  <w-button icon="icon-folder-download" type="primary">下载</w-button>
  <w-button icon="icon-cog" type="info">设置</w-button>
  <w-button icon="icon-plus" type="primary">添加</w-button>
</div>
